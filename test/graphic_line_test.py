...
class TestGraphicLines(TurtleNavalTestBase):
    ...
    def test_point_location_and_expected_side_function_in_q3(self):
        ...
        # points on the line
        # note this first one will actually be to the right of the line very slightly because of rounding
        self.run_line_tst(start_pt=start_pt, end_pt=end_pt, test_pt=start_pt, exp_y=start_pt[1], exp_side=2)
        self.run_line_tst(start_pt=start_pt, end_pt=end_pt, test_pt=end_pt, exp_y=end_pt[1], exp_side=1)
